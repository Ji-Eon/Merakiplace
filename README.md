...
### 회고
  - 최대한 내용에 충실하려 노력했습니다. 아쉬운점은 시간이 많이 없는 관계로 기능 개발을 우선적으로 진행하였으며 본인 나름대로 향후 확장성을 고려했다고 생각하나 코드가 너무길어 리펙토링이 너무 절실하게 필요합니다. 향후 기회가 된다면 이러한 코드를 다양한 눈높이의 의견을 받아 좋은 코드로 발전할수 있도록 진행하고 싶습니다. 감사합니다.
